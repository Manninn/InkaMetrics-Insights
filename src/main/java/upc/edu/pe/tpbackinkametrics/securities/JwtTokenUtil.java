...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        // Ahora esto ya no saldrá en rojo:
        if (userDetails instanceof JwtUserDetails) {
            JwtUserDetails myUser = (JwtUserDetails) userDetails;
            claims.put("idEmpresa", myUser.getIdEmpresa());
        }
    ...
    public int getEmpresaIdFromToken(String token) {
        final Claims claims = getAllClaimsFromToken(token);
        return claims.get("idEmpresa", Integer.class); // Usamos Integer aquí
    }
